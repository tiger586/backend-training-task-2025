...
const weightTraininOneOnOneLessons = 1500
const campaignBudget = 3000
...
let AlexBudget = campaignBudget

AlexBudget -= weightTrainingGroupClass
AlexBudget -= yogaGroupClass * 3
AlexBudget -= weightTraininOneOnOneLessons
...
const classPackage = 2520
const classMinute = 50
const classPrice = 180
const classDiscount = 0.9

// ### 題目五：布林值與變數定義，看是否有用對 const, let
// 情境：Alex 在往健身房的路上，望向城市的風景，請描述她看到的一切，並宣告變數與賦予值
// 4-1. Alex 在等紅綠燈，他抬頭看一下現在是紅燈，還有 28 秒綠燈（最多 3 個宣告）
const trafficLights = ['red', 'yallow', 'green']
let trafficLightsColor = trafficLights[0]
let trafficLightsTime = 28

// 4-2. 目前一起等待的機車有 8 台
let waitingMotorcycle = 8
...
a = 13 // a 的變數重新賦予了一個 13 的數字型別
a = b + 4 // a 的變數重新賦予了一個 b + 4 計算後的值
a - b // 計算 a - b
b += 1 // b 的變數重新賦予了一個 b + 1 計算後的值
...
// 宣告 numberArr1 為 陣列 型別，並賦予值為 [5, 10, 15]
// 宣告 numberArr2 為 陣列 型別，並賦予值為 numberArr1 的參考
// numberArr2 陣列的值最後增加了 20
// numberArr2 的值重新賦予為 [25, 30, 35]
// console.log(numberArr1, numberArr2)
// 顯示內容為 [25, 30, 35] [25, 30, 35]
